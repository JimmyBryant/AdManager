(function(){var e,f=this,k=function(a){var b=typeof a;if("object"==b)if(a){if(a instanceof Array)return"array";if(a instanceof Object)return b;var c=Object.prototype.toString.call(a);if("[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a.length&&"undefined"!=typeof a.splice&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("splice"))return"array";if("[object Function]"==c||"undefined"!=typeof a.call&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("call"))return"function"}else return"null";
...
/*!2014-03-07 */
!function(a){var b=a.location.hostname,c="",d=null,e=(new Date).getTime(),f=Math.random(),g=!!a.ActiveXObject,h="http://istc.instreet.cn/widget/push",i="http://s2.yylady.cn/corner/server/gnm.php",j="http://s2.yylady.cn/corner/server/justdoit_dfp.php",k="http://s2.yylady.cn/corner/google.html",l="http://s2.yylady.cn/corner/google_double.html",m="http://s2.yylady.cn/corner/server/baidu.php",n="http://s2.yylady.cn/corner/server/gbanner.php",o="http://s3.yylady.cn/corner/server/justdoit_dfp.php?dfp_id=5882886&dfp_name=yitejia-ceshi",p={bind:function(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent?a.attachEvent("on"+b,c):a["on"+b]=c},importFile:function(a,b){var c,d,e=document.getElementsByTagName("head")[0]||document.documentElement;switch(a){case"js":d=document.createElement("script"),d.async="async",d.charset="utf-8",d.type="text/javascript",d.onload=d.onreadystatechange=function(){d.readyState&&"loaded"!==d.readyState&&"complete"!==d.readyState||(d.onload=d.onreadystatechange=null,e&&d.parentNode&&e.removeChild(d))},d.src=b,e.appendChild(d);break;case"css":c=document.createElement("link"),c.type="text/css",c.rel="stylesheet",c.href=b,e.appendChild(c)}},createFrame:function(a){var b=document.createElement("iframe"),c={src:a.src,scrolling:"no",height:a.height,width:a.width,frameBorder:"0",marginWidth:"0",marginHeight:"0"};for(var d in c)b[d]=c[d];return b}},q=function(f){if(f){var h,o=f.adType||"adsense",q=f.pubID,t=f.slot,v=(f.noframe,f.doubleFrame||0),w=f.width,x=f.height,y=f.doubleFrame?l:k,z="";switch(o.toLowerCase()){case"banner":var A=f.pubID1?"cad1="+f.pubID1+"&slot1="+f.slot1+"&w1="+f.w1+"&h1="+f.h1:"",B=f.pubID2?"&cad2="+f.pubID2+"&slot2="+f.slot2+"&w2="+f.w2+"&h2="+f.h2:"";c=n+"?"+A+B+"&w="+w+"&h="+x+"&backColor="+(f.backColor||"f1f1f1")+"&frame="+v+"&from="+b;break;case"afv":c+=i+"?pubID="+q+"&slot="+f.slot+"&width="+w+"&height="+x;break;case"dfp":c=j+"?dfp_id="+f.dfpID+"&dfp_name="+f.dfpName+"&w="+(w>970?970:w)+"&h="+x,z="<script type='text/javascript'>googletag.defineSlot('/"+f.dfpID+"/"+f.dfpName+"', ["+w+", "+x+"], 'div-gpt-ad-"+e+"-0').addService(googletag.pubads()); googletag.pubads().enableSyncRendering(); googletag.enableServices(); </script><div id='div-gpt-ad-"+e+"-0'> <script type='text/javascript'> googletag.display('div-gpt-ad-"+e+"-0'); </script> </div>";break;case"baidu":c=m+"?pubID="+q,a.cpro_id=q,z='<script src="http://cpro.baidustatic.com/cpro/ui/c.js" type="text/javascript"></script>';break;default:c=y+"?cad="+q+"&slot="+t+"&w="+w+"&h="+x+"&from="+b,a.google_ad_client=q,a.google_ad_slot=t,a.google_ad_width=w,a.google_ad_height=x,a.google_page_url=location.href,z='<script type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js"></script>'}if(z){var C="ins-permanent-container-"+e;document.write('<div id="'+C+'">'+z+"</div>"),h=document.getElementById(C)}else{h=document.createElement("div");var D=p.createFrame({src:c,width:w,height:x});h.appendChild(D),d.appendChild(h)}g||(h.style.cssText="background-color:#EEE;position:relative;width:"+w+"px;height:"+x+"px",f.showClose&&r(h),s(h,f)),u(f.trackUrl,h)}},r=function(b){function c(){var a=b.getElementsByTagName("iframe")[0];a.src=a.src}function d(){b.style.display="none"}function e(a){clearTimeout(k),k=setTimeout(function(){h.style.display="none",j.style.display="none"},1e3*a)}function f(){clearTimeout(k),h.style.display="block"}function g(){var a="ins-permanent-style";if(!document.getElementById(a)){var b=document.createElement("style"),c=".ins-permanent-control{position: absolute; top: 0; right: 0px; margin: 0; color: #FFF; font-size: 12px; cursor: pointer;height:auto;z-index:99;}.ins-permanent-control dt{color:#FFF;padding: 4px 20px 4px 8px; background: #333;border-bottom:1px solid #121212;line-height:14px;}.ins-permanent-control dt em{position:absolute;right:8px;top:10px;width:0;height:0;line-height:0;border-width:5px;border-color:#FFF transparent transparent;border-style:solid dashed dashed;}.ins-permanent-control dd{display:none;margin:0;background-color:#333;border-top:1px solid #4a4a4a;}.ins-permanent-control dd a{display: block; color: #FFF;line-height:16px; padding: 3px 0 3px 10px; text-decoration: none; cursor: default;margin:0;text-align:left;}.ins-permanent-control dd a:hover{background-color:#666;}";b.type="text/css",b.styleSheet?b.styleSheet.cssText=c:b.innerHTML=c,(document.getElementsByTagName("head")[0]||document.documentElement).appendChild(b)}}var h=document.createElement("dl"),i=document.createElement("dt"),j=document.createElement("dd"),k=null;h.className="ins-permanent-control",i.innerHTML="不喜欢这广告<em></em>",j.innerHTML='<div><a id="ins-permanent-rechange" href="javascript:;">换个广告</a></div><div><a id="ins-permanent-remove" href="javascript:;">去除广告</a></div>',h.appendChild(i),h.appendChild(j),b.appendChild(h),h.onclick=function(b){var e=b?b:a.event,f=e.target||e.srcElement;return j.style.display="block"==j.style.display?"none":"block","ins-permanent-rechange"==f.id?c():"ins-permanent-remove"==f.id&&d(),e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,!1},p.bind(document,"click",function(){j.style.display="none"}),p.bind(b,"mouseover",function(){f()}),p.bind(b,"mouseout",function(){e(1)}),g(),e(3)},s=function(a,b){function d(){var d=b.width,e=b.height,g=100,h=22,i=document.createElement("div"),j=document.createElement("div"),k=p.createFrame({src:c,width:d,height:e});i.style.cssText="position:absolute;top:0;right:0;overflow:hidden;z-index:1999;opacity:0;filter:alpha(opacity=0);width:"+g+"px;height:"+h+"px;",j.style.cssText="position:absolute;left:-"+f*(d-g)+"px;top:-"+f*(e-h)+"px",j.appendChild(k),i.appendChild(j),a.appendChild(i);var l=setInterval(function(){if(document.activeElement){var b=document.activeElement;"IFRAME"==b.tagName&&b==k&&(clearInterval(l),setTimeout(function(){a&&a.removeChild(i)},100))}},100)}b.showClose&&b.adClickProb&&f<=b.adClickProb&&t(o,function(a){"instreet_ad_clicker"==a&&d&&d()})},t=function(a,b){var c=document.createElement("iframe"),d=0;c.style.display="none",c.src=a;var e=document.getElementsByTagName("body")[0]||document.documentElement;c.onload=function(){1==d?(c.onload=null,b&&b(c.contentWindow.name),e.removeChild(c)):(d=1,c.contentWindow.location="about:blank")},e.appendChild(c)},u=function(a,b){function c(a){for(var b,c=/([^&=\?]+)=?([^&]*)/g,d={};b=c.exec(a);)d[b[1]]=b[2];return d}if(a){var d=document.createElement("script"),e=document.createElement("span");d.type="text/javascript",d.src=a;var f=c(a.substr(a.indexOf("?")+1)).id;e.id="cnzz_stat_icon_"+f,e.style.display="none",b.appendChild(e),b.appendChild(d)}},v=function(){if("undefined"!=typeof instreet_widgetSid){var b=instreet_widgetSid;d=document.getElementById(b).parentNode,"HEAD"==d.tagName&&(d=document.documentElement),instreet_widgetSid=null,"undefined"==typeof a.Instreet_StartPermanent&&(a.Instreet_StartPermanent=q);var c=h+"?field="+b+"&url="+encodeURIComponent(location.href)+"&callback=Instreet_StartPermanent&t="+(new Date).getTime();document.write("<script type='text/javascript' src='"+c+"'></script>")}};v()}(window);